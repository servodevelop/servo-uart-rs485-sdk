...
int main (void)
{
    ...
    {   
        // 简易角度控制指令，控制0和1号舵机
        FSUS_SetServoAngle(servoUsart, 0, 135.0, interval, power);
        FSUS_SetServoAngle(servoUsart, 1, 45.0, interval, power);
        // 等待动作完成
...
int main (void)
{
    ...
    {   
        ...
        // 控制舵机角度
        FSUS_SetServoAngle(servoUsart, servoId, nextAngle, interval, power);
        // SysTick_DelayMs(interval);
        SysTick_DelayMs(5);
