namespace FashionStar.Servo.Uart.Protocol
{
    ...
    public class PacketConst
    {
        ...
        public const byte BeginAsync = 18;
        public const byte EndAsync = 19;
        public const byte SartMonitor = 20;
        public const byte StopMonitor = 21;
        public const byte Monitor = 22;
        public const byte SetOriginPoint = 23;
        public const byte StopOnControlMode = 24;
        public const byte SyncCommand = 25;
